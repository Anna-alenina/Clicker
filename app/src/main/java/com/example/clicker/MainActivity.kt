...
class MainActivity : AppCompatActivity() {
    ...
    internal var bestScore: Int = 0
    internal lateinit var tapMeButton: ImageButton
    internal lateinit var gameScoreTextView: TextView
    internal lateinit var bestScoreTextView: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        tapMeButton = findViewById(R.id.tapMeButton)
                //findViewById(androidx.activity.R.id.tapMeButton)
    ...
    private fun resetGame() {
        ...
        currentScore = 0
        gameScoreTextView.text = getString(R.string.Score, currentScore)
        bestScoreTextView.text = getString(R.string.bestScore, bestScore)
    ...
    private fun incrementScore(){
        ...
        currentScore++
        val newScore: String = getString(R.string.Score, currentScore)
